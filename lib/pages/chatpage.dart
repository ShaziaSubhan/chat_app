  ...
  Widget chatMessageTile (String message, bool sendByMe){
    ...
    children: [
      Flexible(child: Container(
        ...
        margin: EdgeInsets.symmetric(horizontal: 26,vertical: 4),
        decoration: BoxDecoration(borderRadius: BorderRadius.only(topLeft: Radius.circular(24),
          ...
          color: sendByMe?Color(0xFFCE93D8):Color(0xFFF3E5F5),),

         child: Text(message,style: TextStyle(color: Colors.black,fontSize: 15.0,fontWeight: FontWeight.w500),),
      )),
    ],
    );
  }
          ...
          children:[
            ...
            Padding(
              ...
              child: Row(
               ...
               SizedBox(width: 90.0,),
               Text(widget.name,style: TextStyle(color: Color(0Xffc199cd),
                fontSize: 20.0,
